...
class SupervisorCounselorHistoryListPage
    extends GetView<SupervisorCounselorHistoryListController> {
  const SupervisorCounselorHistoryListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<SupervisorCounselorHistoryListController>(
        init: SupervisorCounselorHistoryListController(),
        initState: (_) {},
        builder: (_) {
