...
class SupervisorCounselorHistoryFragment
    extends GetView<SupervisorCounselorHistoryController> {
  const SupervisorCounselorHistoryFragment({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SupervisorCounselorHistoryController>(
      init: SupervisorCounselorHistoryController(),
      initState: (_) {},
      builder: (_) {
