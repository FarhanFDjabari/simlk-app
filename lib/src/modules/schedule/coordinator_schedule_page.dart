...
class CoordinatorSchedulePage extends GetView<CoordinatorScheduleController> {
  const CoordinatorSchedulePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, index) {
                return Obx(
                  () => CustomChip(
                    label: controller.dummyDateChip[index],
              ...
              itemCount: controller.dummyDateChip.length,
            ),
          ),
          GetBuilder<CoordinatorScheduleController>(
            builder: (_) => Expanded(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          controller.goToCreateCounselor();
        },
        child: Icon(
          Remix.user_add_fill,
