...
class CoordinatorReservationDetailPage
    extends GetView<CoordinatorReservationDetailController> {
  const CoordinatorReservationDetailPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<CoordinatorReservationDetailController>(
        init: CoordinatorReservationDetailController(),
        initState: (_) {},
        builder: (_) {
