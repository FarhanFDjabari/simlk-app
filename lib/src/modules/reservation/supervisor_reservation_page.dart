...
class SupervisorReservationPage
    extends GetView<SupervisorReservationController> {
  const SupervisorReservationPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<SupervisorReservationController>(
        builder: (_) {
