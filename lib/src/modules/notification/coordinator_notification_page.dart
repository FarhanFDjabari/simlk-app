...
class CoordinatorNotificationPage
    extends GetView<CoordinatorNotificationController> {
  const CoordinatorNotificationPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<CoordinatorNotificationController>(
        builder: (_) {
